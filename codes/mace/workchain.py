...
class MACEBaseWorkChain(BaseRestartWorkChain):
    ...
    def define(cls, spec):
        ...
        spec.exit_code(
            ...
            message='Maximum number of restarts exceeded for MACEBaseWorkChain.'
        )
    ...
    def setup(self):
        ...
        self.ctx.inputs = {
            ...
            'parameters': Dict(dict={
                'job_type': job_info['job_type'],
                'num_structures': job_info['num_structures'],
