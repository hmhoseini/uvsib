...
with open(os.path.join(uvsib_directory, 'run_dir', 'input.yaml'), 'r', encoding='utf8') as fhandle:
    inputs = yaml.safe_load(fhandle)

with open(os.path.join(uvsib_directory, 'run_dir', 'config.yaml'), 'r', encoding='utf8') as fhandle:
